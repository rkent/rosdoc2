...
templates_path = ['/home/kent/github/rkent/rosdoc2/test/data/minimum_cpp/_templates']
exclude_patterns = []
master_doc = "index"
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    sys.path.insert(0, os.path.dirname('/home/kent/github/rkent/rosdoc2/test/data/minimum_cpp/None'))
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        breathe_projects.update({        "minimum_cpp Doxygen Project": "/tmp/pytest-of-kent/pytest-1/test_builder0/build/minimum_cpp/output_staging/generated/doxygen/xml"
    })
        if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        exhale_args.update({
            ...
            "containmentFolder": "/home/kent/github/rkent/rosdoc2/test/data/minimum_cpp/generated/cpp",
            "rootFileName": "index.rst",
            "rootFileTitle": "minimum_cpp C/C++ API",
