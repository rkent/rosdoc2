...
templates_path = ['/home/kent/github/rkent/rosdoc2/test/data/minimum_package/_templates']
exclude_patterns = []
master_doc = "index"
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    autodoc_mock_imports = ['rosidl_default_runtime']
    import importlib
    ...
    sys.path.insert(0, os.path.dirname('/home/kent/github/rkent/rosdoc2/test/data/minimum_package/None'))
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        exhale_args.update({
            ...
            "containmentFolder": "/home/kent/github/rkent/rosdoc2/test/data/minimum_package/generated/cpp",
            "rootFileName": "index.rst",
            "rootFileTitle": "minimum_package C/C++ API",
