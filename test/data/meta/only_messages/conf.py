...
project = "only_messages"
copyright = "2024, Some ol' Guy  (Apache License 2.0)"
author = "Some ol' Guy"
release = "0.1.3"
version = "0.1"
extensions = ['sphinx.ext.viewcode']
templates_path = ['/home/kent/github/rkent/rosdoc2/test/data/meta/only_messages/_templates']
exclude_patterns = []
master_doc = "index"
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    sys.path.insert(0, os.path.dirname('/home/kent/github/rkent/rosdoc2/test/data/meta/only_messages/None'))
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        exhale_args.update({
            ...
            "containmentFolder": "/home/kent/github/rkent/rosdoc2/test/data/meta/only_messages/generated/cpp",
            "rootFileName": "index.rst",
            "rootFileTitle": "only_messages C/C++ API",
...
for tag in ['package_name', 'package_version', 'package_description', 'package_directory', 'breathe_projects', 'containmentFolder', 'build_type', 'exec_depends', 'package', 'package_authors', 'package_licenses', 'package_src_directory', 'package_underline', 'package_version_short', 'root_title', 'root_title_underline', 'sphinx_sourcedir', 'has_standard_docs', 'has_msg_defs', 'has_cpp', 'has_readme', 'doclist']:
    tags.add(tag)
