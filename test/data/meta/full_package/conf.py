...
project = "full_package"
copyright = "2024, Some One  (Apache License 2.0)"
author = "Some One"
release = "0.1.3"
version = "0.1"
extensions = ['sphinx.ext.viewcode']
templates_path = ['/home/kent/github/rkent/rosdoc2/test/data/meta/full_package/_templates']
exclude_patterns = []
master_doc = "index"
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    sys.path.insert(0, os.path.dirname('/home/kent/github/rkent/rosdoc2/test/data/meta/full_package/full_package'))
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        breathe_projects.update({        "full_package Doxygen Project": "/tmp/pytest-of-kent/pytest-1/test_builder0/build/full_package/output_staging/generated/doxygen/xml"
    })
        if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        exhale_args.update({
            ...
            "containmentFolder": "/home/kent/github/rkent/rosdoc2/test/data/meta/full_package/generated/cpp",
            "rootFileName": "index.rst",
            "rootFileTitle": "full_package C/C++ API",
...
for tag in ['package_name', 'package_version', 'package_description', 'package_directory', 'python_src', 'breathe_projects', 'containmentFolder', 'did_run_doxygen', 'build_type', 'exec_depends', 'intersphinx_mapping_extensions', 'package', 'package_authors', 'package_licenses', 'package_src_directory', 'package_underline', 'package_version_short', 'root_title', 'root_title_underline', 'url_bugtracker', 'url_repository', 'url_website', 'sphinx_sourcedir', 'has_standard_docs', 'has_msg_defs', 'has_srv_defs', 'has_cpp', 'has_python', 'has_readme', 'extra_doc_files', 'doclist']:
    tags.add(tag)
