...
templates_path = ['/home/kent/github/rkent/rosdoc2/test/data/meta/meta_package/_templates']
exclude_patterns = []
master_doc = "index"
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    autodoc_mock_imports = ['full_package', 'only_messages']
    import importlib
    ...
    sys.path.insert(0, os.path.dirname('/home/kent/github/rkent/rosdoc2/test/data/meta/meta_package/None'))
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    if is_doxygen_invoked:
        ...
        exhale_args.update({
            ...
            "containmentFolder": "/home/kent/github/rkent/rosdoc2/test/data/meta/meta_package/generated/cpp",
            "rootFileName": "index.rst",
            "rootFileTitle": "meta_package C/C++ API",
...
for tag in ['package_name', 'package_version', 'package_description', 'package_directory', 'breathe_projects', 'containmentFolder', 'build_type', 'exec_depends', 'intersphinx_mapping_extensions', 'package', 'package_authors', 'package_licenses', 'package_src_directory', 'package_underline', 'package_version_short', 'root_title', 'root_title_underline', 'sphinx_sourcedir', 'meta_dependencies', 'doclist']:
    tags.add(tag)
